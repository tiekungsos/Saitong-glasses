					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="">ข้อมูลสินค้า</a></li>
							</ul>
						</div>
					</div>
				</div>
										...
										<div class="product-des">
											...
											<div class="short">
												...
												<div class="rating-main">
													...
													<a href="#" class="total-review">({{$product_detail['getReview']->count()}}) รีวิว</a>
                                                </div>
                                                @php 
											...
											<div class="product-buy">
												<form action="{{route('single-add-to-cart')}}" method="POST">
													...
													<div class="add-to-cart mt-4">
														<button type="submit" class="btn">เพิ่มไปยังตะกร้า</button>
														<!-- <a href="{{route('add-to-wishlist',$product_detail->slug)}}" class="btn min"><i class="ti-heart"></i></a> -->
													</div>
												</form>

												<p class="cat">ประเภทสินค้า<a href="{{route('product-cat',$product_detail->cat_info['slug'])}}">{{$product_detail->cat_info['title']}}</a></p>
												@if($product_detail->sub_cat_info)
												<p class="cat mt-1">Sub ประเภทสินค้า<a href="{{route('product-sub-cat',[$product_detail->cat_info['slug'],$product_detail->sub_cat_info['slug']])}}">{{$product_detail->sub_cat_info['title']}}</a></p>
												@endif
												<p class="availability">จำนวนคงเหลือ : @if($product_detail->stock>0)<span class="badge badge-success">{{$product_detail->stock}}</span>@else <span class="badge badge-danger">{{$product_detail->stock}}</span>  @endif</p>
											</div>
											<!--/ End Product Buy -->
										</div>
									</div>
                                    ...
                                    <div class="product-img">
                                        ...
                                        <div class="button-head">
                                            ...
                                            <div class="product-action-2">
                                                <a title="เพิ่มไปยังตะกร้า" href="#">เพิ่มไปยังตะกร้า</a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="quickview-content">
                            ...
                            <div class="add-to-cart">
                                <a href="#" class="btn">เพิ่มไปยังตะกร้า</a>
