...
@section('main-content')
				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="javascript:void(0);">ติดต่อสอบถาม</a></li>
						</ul>
					</div>
				</div>
			</div>
						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									@endphp
									<h4>ติดต่อสอบถาม</h4>
									<h3>ติดต่อสอบถามหรือรายงานปัญหาในการใช้งาน @auth @else<span style="font-size:12px;" class="text-danger">[กรอกข้อมูลแล้วเจ้าหน้าที่จะติดต่อกลับไป]</span>@endauth</h3>
								</div>
								<form class="form-contact form contact_form" method="post" action="{{route('contact.store')}}" id="contactForm" novalidate="novalidate">
									...
									<div class="row">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>เรื่องที่ต้องการติดต่อ<span>*</span></label>
										...
										<div class="col-12">
											<div class="form-group button">
												<button type="submit" class="btn ">ส่งเรื่อง</button>
											</div>
										</div>
									</div>
								</form>
	...
	<div class="map-section">
		<div id="myMap">
		<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d472.1737827702783!2d98.99175091964341!3d18.780753443725064!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x77a3c2339300fbca!2z4LmA4Liq4LmJ4LiZ4LiX4Lit4LiH4LiB4Liy4Lij4LmB4Lin4LmI4LiZ!5e0!3m2!1sen!2sth!4v1610980075384!5m2!1sen!2sth" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
		</div>
	</div>
	<!--/ End Map Section -->
