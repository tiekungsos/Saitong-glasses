			...
			<div class="row">
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							<li><a href="{{('home')}}">หน้าแรก<i class="ti-arrow-right"></i></a></li>
							<li class="active"><a href="">ตะกร้า</a></li>
						</ul>
					</div>
				</div>
			</div>
								...
								@if(Helper::getAllProductFromCart())
									...
									<track>
										...
										<td class="float-right">
											<button class="btn float-right" type="submit">อัพเดตตะกร้า</button>
										</td>
									</track>
								@else 
										<tr>
					...
					<div class="total-amount">
						<div class="row">
							<div class="col-lg-8 col-md-5 col-12">
								<div class="left">
									...
									<form action="{{route('coupon-store')}}" method="POST">
											@csrf
											<input name="code" placeholder="กรอกรหัสส่วนลด">
											<button class="btn">ใช้รหัสส่วนลด</button>
										</form>
									</div>
									{{-- <div class="checkbox">`
										@php 
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}">ราคารวม<span>฿{{number_format(Helper::totalCartPrice(),2)}}</span></li>
										...
										@endphp
										@if(session()->has('coupon'))ยอดชำระทั้งหมด
									...
									<div class="button5">
										<a href="{{route('checkout')}}" class="btn">ดำเนินการชำระเงิน</a>
										<a href="{{route('product-grids')}}" class="btn">เลือกซื้อสินค้าอื่นต่อ</a>
									</div>
								</div>
							</div>
						</div>
